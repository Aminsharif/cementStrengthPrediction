...
class Model_Finder:
    """
        his class shall  be used to find the model with best accuracy and AUC score.
    ...
    def get_best_params_for_Random_Forest_Regressor(self, train_x, train_y):
        ...
        logging.info('Entered the RandomForestReg method of the Model_Finder class')
        try:
            ...
            logging.info('RandomForestReg best params: ' + str(self.grid.best_params_) + '. Exited the RandomForestReg method of the Model_Finder class')
            return self.decisionTreeReg
        except Exception as e:
            logging.info('Exception occured in RandomForestReg method of the Model_Finder class. Exception message:  ' + str(e))
            logging.info('RandomForestReg Parameter tuning  failed. Exited the knn method of the Model_Finder class')
    ...
    def get_best_params_for_linearReg(self,train_x,train_y):
        ...
        """
        logging.info('Entered the get_best_params_for_linearReg method of the Model_Finder class')
        try:
            # initializing with different combination of parameters
            ...
            logging.info('LinearRegression best params: ' + str(self.grid.best_params_) + '. Exited the get_best_params_for_linearReg method of the Model_Finder class')
            return self.linReg
        except Exception as e:
            logging.info('Exception occured in get_best_params_for_linearReg method of the Model_Finder class. Exception message:  ' + str(e))
            logging.info('LinearReg Parameter tuning  failed. Exited the get_best_params_for_linearReg method of the Model_Finder class')
            raise CustomException(e, sys)
